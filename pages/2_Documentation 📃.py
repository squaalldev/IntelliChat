...
# Footer Section
st.write("For further details, please refer to the [project repository](https://github.com/miteshgupta07/QA-Chatbot) or contact me through the links provided on the '[About Me](#About-me-😎)' page.")
st.sidebar.page_link("pages/3_About me 😎.py", label="Page 1", icon="1️⃣")